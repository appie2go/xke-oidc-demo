...
public class AccountController : Controller
{
    ...
    public async Task<IActionResult> Logout(LogOutInputModel model)
    {
        ...
        return Redirect("/connect/authorize?client_id=demo&response_type=id_token token&redirect_uri=https://localhost:7185/redirect&scope=openid profile IdentityServerApi&nonce=234562461246");
    }
}